# Prefill / TTFT roadmap — GLM-5.3 on rome (opened 2026-09-06, rev 9, 2026-09-07 01:30)
...
| **P6** ✅ | Make reuse survive Open WebUI (`cb9c11e`; **in service 2026-09-06 23:30**: `--kv-slots 4`, `COLI_KDA_GPU=0`; `tworeq` identical across slots at both knobs; live-gateway side-request case turn 2 **171 s → 3.1 s**, REUSE 1 339/1 355 — §P6 in the record). Left for the user's real chats: the server log's REUSE lines will show whether Open WebUI's system prompt is byte-stable across turns | | | | | met |
